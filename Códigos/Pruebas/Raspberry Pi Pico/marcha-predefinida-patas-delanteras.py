import time #Libreria para manera los tiempos de espera
import pwmio #Crear PMWs
from adafruit_motor import servo #Mover servomotores
import math #Operaciones matemáticas(tangente inversa)
import board #Importar la placa de desarrollo(ESP32) con el comando print(dir(board)) se ven los pines
